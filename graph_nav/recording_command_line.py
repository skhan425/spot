"""Command line interface integrating options to record maps. """
import argparse
import json
import logging
import os
...
class RecordingInterface(object):
    ...
    def __init__(self, robot, download_filepath, download_name, client_metadata, use_gps=False):
        ...
        self._download_filepath = os.path.join(download_filepath, download_name)
